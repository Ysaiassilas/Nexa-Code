document.addEventListener("DOMContentLoaded", () => {
    ...
    const adicionarProjetosPortfolio = () => {
        ...
        const projetos = [
            ...
            { nome: "NutryFit", descricao: "Uma aplicação que permite a análise do estado nutricional de pacientes com base em informações como IMC, idade, altura,peso, percentual de gordura e outras métricas.", link: "https://joao6632.github.io/NutryFit-v2/", imagem: "./imgens-projetos/NutryFit.png" },
            ...
            { nome: "Pyxis tour Brasil", descricao: "Sistema feito para uma agência de viagens. Permitindo a visão de melhores serviços para viagens e hospedagem. ", link: "https://www.strava.com/mobile", imagem: "./imgens-projetos/Pyxis.png" },
