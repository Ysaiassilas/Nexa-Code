document.addEventListener("DOMContentLoaded", () => {
    ...
    const adicionarProjetosPortfolio = () => {
        ...
        const projetos = [
            ...
            { nome: "NutryFit", descricao: "Um software que permite a análise do estado nutricional de pacientes com base em informações como IMC, idade, altura,peso, percentual de gordura e outras métricas.", link: "https://joao6632.github.io/NutryFit-v2/", imagem: "./imgens-projetos/NutryFit.png" },
